...
export function Sidebar({ screen, go, openSettings, unreadNotifCount = 0 }: Props) {
  return (
    <div style={{
      ...
      {/* Bottom utility row: settings + bell */}
      <div style={{ display: "flex", alignItems: "center" }}>
        {/* Settings — same style as nav items */}
        <button
          onClick={openSettings}
          style={{
            flex: 1, display: "flex", alignItems: "center", gap: 12, padding: "12px 14px",
            background: "transparent", border: "none", borderRadius: 10,
            color: T.creamDim, textAlign: "left", fontSize: 13, letterSpacing: "0.05em", cursor: "pointer",
          }}
        >
        ...
        <button
          ...
          style={{
            ...
            color: screen === "notifications" ? T.cream : T.creamDim,
            cursor: "pointer",
          }}
        >
